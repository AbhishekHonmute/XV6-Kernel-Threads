...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 fb 7a 10 80 	movl   $0x80107afb,(%esp)
...
80102020:	68 e2 78 10 80       	push   $0x801078e2
...
801037df:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037e5:	e8 96 0e 00 00       	call   80104680 <release>
...
80103807:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010380a:	c7 40 14 26 59 10 80 	movl   $0x80105926,0x14(%eax)
  p->context = (struct context*)sp;
...
80103819:	e8 b2 0e 00 00       	call   801046d0 <memset>
...
80103842:	e8 39 0e 00 00       	call   80104680 <release>
}
...
8010387f:	e8 fc 0d 00 00       	call   80104680 <release>
...
801038ca:	68 c0 76 10 80       	push   $0x801076c0
801038cf:	68 20 2d 11 80       	push   $0x80112d20
801038d4:	e8 67 0b 00 00       	call   80104440 <initlock>
}
...
80103978:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010397b:	e8 40 0b 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103980:	e8 5b ff ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103985:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010398b:	e8 80 0b 00 00       	call   80104510 <popcli>
}
...
801039b7:	e8 34 35 00 00       	call   80106ef0 <setupkvm>
...
801039d5:	e8 e6 31 00 00       	call   80106bc0 <inituvm>
...
801039ea:	e8 e1 0c 00 00       	call   801046d0 <memset>
...
80103a43:	68 f0 76 10 80       	push   $0x801076f0
80103a48:	50                   	push   %eax
80103a49:	e8 42 0e 00 00       	call   80104890 <safestrcpy>
  p->cwd = namei("/");
80103a4e:	c7 04 24 f9 76 10 80 	movl   $0x801076f9,(%esp)
...
80103a87:	68 d7 76 10 80       	push   $0x801076d7
...
80103aa9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103aac:	e8 0f 0a 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103ab1:	e8 2a fe ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103ab6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103abc:	e8 4f 0a 00 00       	call   80104510 <popcli>
  sz = curproc->sz;
...
80103acf:	e8 dc 2f 00 00       	call   80106ab0 <switchuvm>
  return 0;
...
80103aea:	e8 21 32 00 00       	call   80106d10 <allocuvm>
...
80103b0a:	e8 31 33 00 00       	call   80106e40 <deallocuvm>
...
80103b2a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b2d:	e8 8e 09 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103b32:	e8 a9 fd ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103b37:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b3d:	e8 ce 09 00 00       	call   80104510 <popcli>
  if((np = allocproc()) == 0){
...
80103b5c:	e8 5f 34 00 00       	call   80106fc0 <copyuvm>
...
80103c48:	83 ec 10             	sub    $0x10,%esp
80103c4b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  cprintf("This is clone function\n");
80103c4e:	68 fb 76 10 80       	push   $0x801076fb
80103c53:	e8 58 ca ff ff       	call   801006b0 <cprintf>
  return arg * arg;
80103c58:	89 d8                	mov    %ebx,%eax
80103c5a:	0f af c3             	imul   %ebx,%eax
}
...
80103c7a:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103c7d:	e8 5e fc ff ff       	call   801038e0 <mycpu>
  c->proc = 0;
...
80103ca6:	e8 15 09 00 00       	call   801045c0 <acquire>
...
80103cc0:	e8 eb 2d 00 00       	call   80106ab0 <switchuvm>
...
80103ccb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103cd2:	e8 1c 0c 00 00       	call   801048f3 <swtch>
      switchkvm();
80103cd7:	e8 b4 2d 00 00       	call   80106a90 <switchkvm>
      c->proc = 0;
...
80103d5b:	75 41                	jne    80103d9e <sched+0x8e>
  intena = mycpu()->intena;
80103d5d:	e8 7e fb ff ff       	call   801038e0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103d62:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103d65:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103d6b:	e8 70 fb ff ff       	call   801038e0 <mycpu>
80103d70:	83 ec 08             	sub    $0x8,%esp
80103d73:	ff 70 04             	pushl  0x4(%eax)
80103d76:	53                   	push   %ebx
80103d77:	e8 77 0b 00 00       	call   801048f3 <swtch>
  mycpu()->intena = intena;
80103d7c:	e8 5f fb ff ff       	call   801038e0 <mycpu>
}
...
80103dda:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103ddd:	e8 de 06 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103de2:	e8 f9 fa ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103de7:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ded:	e8 1e 07 00 00       	call   80104510 <popcli>
  if(curproc == initproc)
...
80103e4a:	e8 71 07 00 00       	call   801045c0 <acquire>
...
80103e88:	75 e2                	jne    80103e6c <exit+0x9c>
      p->parent = initproc;
80103e8a:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103ef7:	68 60 77 10 80       	push   $0x80107760
80103efc:	e8 8f c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103f01:	83 ec 0c             	sub    $0xc,%esp
80103f04:	68 53 77 10 80       	push   $0x80107753
...
80103f25:	e8 96 05 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103f2a:	e8 b1 f9 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
...
80103f73:	e8 48 05 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103f78:	e8 63 f9 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
...
80104009:	68 72 77 10 80       	push   $0x80107772
8010400e:	e8 7d c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80104013:	83 ec 0c             	sub    $0xc,%esp
80104016:	68 6c 77 10 80       	push   $0x8010776c
...
80104029:	e8 92 04 00 00       	call   801044c0 <pushcli>
  c = mycpu();
8010402e:	e8 ad f8 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
...
80104060:	81 c3 88 00 00 00    	add    $0x88,%ebx
80104066:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
...
80104077:	74 37                	je     801040b0 <wait+0x90>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104079:	81 c3 88 00 00 00    	add    $0x88,%ebx
      havekids = 1;
8010407f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104084:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
...
801040c2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801040c9:	e8 a2 2d 00 00       	call   80106e70 <freevm>
        release(&ptable.lock);
801040ce:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
...
80104148:	05 88 00 00 00       	add    $0x88,%eax
8010414d:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
8010415f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104166:	05 88 00 00 00       	add    $0x88,%eax
8010416b:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80104170:	75 e2                	jne    80104154 <wakeup+0x34>
  wakeup1(chan);
  release(&ptable.lock);
80104172:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
...
801041b8:	05 88 00 00 00       	add    $0x88,%eax
801041bd:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
801041e0:	68 20 2d 11 80       	push   $0x80112d20
...
80104243:	68 fb 7a 10 80       	push   $0x80107afb
80104248:	e8 63 c4 ff ff       	call   801006b0 <cprintf>
8010424d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104250:	81 c3 88 00 00 00    	add    $0x88,%ebx
80104256:	81 fb c0 4f 11 80    	cmp    $0x80114fc0,%ebx
...
80104267:	74 e7                	je     80104250 <procdump+0x30>
      state = "???";
80104269:	ba 83 77 10 80       	mov    $0x80107783,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010426e:	83 f8 05             	cmp    $0x5,%eax
80104271:	77 11                	ja     80104284 <procdump+0x64>
80104273:	8b 14 85 e4 77 10 80 	mov    -0x7fef881c(,%eax,4),%edx
      state = "???";
8010427a:	b8 83 77 10 80       	mov    $0x80107783,%eax
...
80104289:	68 87 77 10 80       	push   $0x80107787
...
801042d1:	68 c1 71 10 80       	push   $0x801071c1
...
8010430e:	68 fc 77 10 80       	push   $0x801077fc
...
8010437b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104381:	e8 ea f5 ff ff       	call   80103970 <myproc>
...
80104555:	68 07 78 10 80       	push   $0x80107807
8010455a:	e8 31 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010455f:	83 ec 0c             	sub    $0xc,%esp
80104562:	68 1e 78 10 80       	push   $0x8010781e
...
8010459b:	e8 40 f3 ff ff       	call   801038e0 <mycpu>
...
80104604:	e8 d7 f2 ff ff       	call   801038e0 <mycpu>
...
80104667:	68 25 78 10 80       	push   $0x80107825
...
801046c0:	68 2d 78 10 80       	push   $0x8010782d
...
80104a0c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104a0f:	e8 5c ef ff ff       	call   80103970 <myproc>
...
80104aa8:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104aab:	e8 c0 ee ff ff       	call   80103970 <myproc>
...
80104abb:	83 fa 15             	cmp    $0x15,%edx
80104abe:	77 20                	ja     80104ae0 <syscall+0x40>
80104ac0:	8b 14 85 60 78 10 80 	mov    -0x7fef87a0(,%eax,4),%edx
...
80104ae8:	68 35 78 10 80       	push   $0x80107835
...
80104c44:	68 d8 78 10 80       	push   $0x801078d8
...
80104c5c:	68 d7 78 10 80       	push   $0x801078d7
...
80104c71:	68 cb 78 10 80       	push   $0x801078cb
...
80104c8f:	68 da 78 10 80       	push   $0x801078da
80104c94:	e8 f7 b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c99:	83 ec 0c             	sub    $0xc,%esp
80104c9c:	68 bc 78 10 80       	push   $0x801078bc
...
80104cd4:	e8 97 ec ff ff       	call   80103970 <myproc>
...
80104d1d:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104d1f:	e8 4c ec ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104e67:	78 27                	js     80104e90 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104e69:	e8 02 eb ff ff       	call   80103970 <myproc>
...
8010508d:	58                   	pop    %eax
8010508e:	5a                   	pop    %edx
8010508f:	68 d8 78 10 80       	push   $0x801078d8
...
801050a8:	68 d7 78 10 80       	push   $0x801078d7
...
80105297:	74 23                	je     801052bc <sys_open+0x9c>
  struct proc *curproc = myproc();
80105299:	e8 d2 e6 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105479:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010547c:	e8 ef e4 ff ff       	call   80103970 <myproc>
...
8010565b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010565d:	e8 0e e3 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056a7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801056aa:	e8 c1 e2 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056c6:	75 f0                	jne    801056b8 <sys_pipe+0x98>
      myproc()->ofile[fd0] = 0;
801056c8:	e8 a3 e2 ff ff       	call   80103970 <myproc>
...
80105790:	e8 1b f2 ff ff       	call   801049b0 <argint>
...
801057a2:	e8 e9 e9 ff ff       	call   80104190 <kill>
...
801057c7:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801057ca:	e8 a1 e1 ff ff       	call   80103970 <myproc>
...
8010580a:	e8 91 e2 ff ff       	call   80103aa0 <growproc>
...
80105841:	e8 6a f1 ff ff       	call   801049b0 <argint>
...
80105854:	68 60 4f 11 80       	push   $0x80114f60
80105859:	e8 62 ed ff ff       	call   801045c0 <acquire>
  ticks0 = ticks;
...
8010588f:	73 2f                	jae    801058c0 <sys_sleep+0x90>
    if(myproc()->killed){
80105891:	e8 da e0 ff ff       	call   80103970 <myproc>
...
801058a5:	e8 d6 ed ff ff       	call   80104680 <release>
  }
  release(&tickslock);
  return 0;
}
...
801058c8:	e8 b3 ed ff ff       	call   80104680 <release>
  return 0;
...
801058e8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058eb:	68 60 4f 11 80       	push   $0x80114f60
801058f0:	e8 cb ec ff ff       	call   801045c0 <acquire>
  xticks = ticks;
801058f5:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  release(&tickslock);
801058fb:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
80105902:	e8 79 ed ff ff       	call   80104680 <release>
  return xticks;
}
...
80105957:	c7 04 c5 a2 4f 11 80 	movl   $0x8e000008,-0x7feeb05e(,%eax,8)
8010595e:	08 00 00 8e 
80105962:	66 89 14 c5 a0 4f 11 	mov    %dx,-0x7feeb060(,%eax,8)
80105969:	80 
8010596a:	c1 ea 10             	shr    $0x10,%edx
8010596d:	66 89 14 c5 a6 4f 11 	mov    %dx,-0x7feeb05a(,%eax,8)
80105974:	80 
  for(i = 0; i < 256; i++)
...
80105987:	c7 05 a2 51 11 80 08 	movl   $0xef000008,0x801151a2
8010598e:	00 00 ef 
  initlock(&tickslock, "time");
80105991:	68 1d 79 10 80       	push   $0x8010791d
80105996:	68 60 4f 11 80       	push   $0x80114f60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010599b:	66 a3 a0 51 11 80    	mov    %ax,0x801151a0
801059a1:	c1 e8 10             	shr    $0x10,%eax
801059a4:	66 a3 a6 51 11 80    	mov    %ax,0x801151a6
  initlock(&tickslock, "time");
...
801059cf:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059d3:	b8 a0 4f 11 80       	mov    $0x80114fa0,%eax
...
80105a14:	3e ff 24 85 c4 79 10 	notrack jmp *-0x7fef863c(,%eax,4)
80105a1b:	80 
    lapiceoi();
    break;
...
80105a1c:	e8 4f df ff ff       	call   80103970 <myproc>
...
80105a3c:	e8 0f df ff ff       	call   80103950 <cpuid>
...
80105a71:	68 80 79 10 80       	push   $0x80107980
...
80105a8a:	e8 e1 de ff ff       	call   80103970 <myproc>
80105a8f:	85 c0                	test   %eax,%eax
80105a91:	74 1d                	je     80105ab0 <trap+0xc0>
80105a93:	e8 d8 de ff ff       	call   80103970 <myproc>
...
80105ac2:	0f 84 e8 00 00 00    	je     80105bb0 <trap+0x1c0>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ac8:	e8 a3 de ff ff       	call   80103970 <myproc>
...
80105afb:	e8 c0 cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b00:	e8 6b de ff ff       	call   80103970 <myproc>
80105b05:	85 c0                	test   %eax,%eax
80105b07:	75 8a                	jne    80105a93 <trap+0xa3>
80105b09:	eb a5                	jmp    80105ab0 <trap+0xc0>
    if(cpuid() == 0){
80105b0b:	e8 40 de ff ff       	call   80103950 <cpuid>
80105b10:	85 c0                	test   %eax,%eax
80105b12:	75 e7                	jne    80105afb <trap+0x10b>
      acquire(&tickslock);
80105b14:	83 ec 0c             	sub    $0xc,%esp
80105b17:	68 60 4f 11 80       	push   $0x80114f60
80105b1c:	e8 9f ea ff ff       	call   801045c0 <acquire>
      wakeup(&ticks);
80105b21:	c7 04 24 a0 57 11 80 	movl   $0x801157a0,(%esp)
      ticks++;
80105b28:	83 05 a0 57 11 80 01 	addl   $0x1,0x801157a0
      wakeup(&ticks);
80105b2f:	e8 ec e5 ff ff       	call   80104120 <wakeup>
      release(&tickslock);
80105b34:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
80105b3b:	e8 40 eb ff ff       	call   80104680 <release>
...
80105b4a:	e8 71 cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b4f:	e8 1c de ff ff       	call   80103970 <myproc>
...
80105b66:	e8 55 cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b6b:	e8 00 de ff ff       	call   80103970 <myproc>
...
80105b84:	e8 c7 dd ff ff       	call   80103950 <cpuid>
80105b89:	57                   	push   %edi
80105b8a:	56                   	push   %esi
80105b8b:	50                   	push   %eax
80105b8c:	68 28 79 10 80       	push   $0x80107928
...
80105bb4:	0f 85 0e ff ff ff    	jne    80105ac8 <trap+0xd8>
    yield();
80105bba:	e8 51 e3 ff ff       	call   80103f10 <yield>
...
80105bd2:	75 3c                	jne    80105c10 <trap+0x220>
    myproc()->tf = tf;
80105bd4:	e8 97 dd ff ff       	call   80103970 <myproc>
80105bd9:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105bdc:	e8 bf ee ff ff       	call   80104aa0 <syscall>
    if(myproc()->killed)
...
80105c28:	68 4c 79 10 80       	push   $0x8010794c
80105c2d:	e8 7e aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105c32:	83 c4 14             	add    $0x14,%esp
80105c35:	68 22 79 10 80       	push   $0x80107922
...
80105d33:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105d38:	bb 44 7a 10 80       	mov    $0x80107a44,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105dcb:	6a 00                	push   $0x0
  jmp alltraps
80105dcd:	e9 3c fb ff ff       	jmp    8010590e <alltraps>
...
80105dd4:	6a 01                	push   $0x1
  jmp alltraps
80105dd6:	e9 33 fb ff ff       	jmp    8010590e <alltraps>
...
80105ddd:	6a 02                	push   $0x2
  jmp alltraps
80105ddf:	e9 2a fb ff ff       	jmp    8010590e <alltraps>
...
80105de6:	6a 03                	push   $0x3
  jmp alltraps
80105de8:	e9 21 fb ff ff       	jmp    8010590e <alltraps>
...
80105def:	6a 04                	push   $0x4
  jmp alltraps
80105df1:	e9 18 fb ff ff       	jmp    8010590e <alltraps>
...
80105df8:	6a 05                	push   $0x5
  jmp alltraps
80105dfa:	e9 0f fb ff ff       	jmp    8010590e <alltraps>
...
80105e01:	6a 06                	push   $0x6
  jmp alltraps
80105e03:	e9 06 fb ff ff       	jmp    8010590e <alltraps>
...
80105e0a:	6a 07                	push   $0x7
  jmp alltraps
80105e0c:	e9 fd fa ff ff       	jmp    8010590e <alltraps>
...
80105e11:	6a 08                	push   $0x8
  jmp alltraps
80105e13:	e9 f6 fa ff ff       	jmp    8010590e <alltraps>
...
80105e1a:	6a 09                	push   $0x9
  jmp alltraps
80105e1c:	e9 ed fa ff ff       	jmp    8010590e <alltraps>
...
80105e21:	6a 0a                	push   $0xa
  jmp alltraps
80105e23:	e9 e6 fa ff ff       	jmp    8010590e <alltraps>
...
80105e28:	6a 0b                	push   $0xb
  jmp alltraps
80105e2a:	e9 df fa ff ff       	jmp    8010590e <alltraps>
...
80105e2f:	6a 0c                	push   $0xc
  jmp alltraps
80105e31:	e9 d8 fa ff ff       	jmp    8010590e <alltraps>
...
80105e4f:	6a 10                	push   $0x10
  jmp alltraps
80105e51:	e9 b8 fa ff ff       	jmp    8010590e <alltraps>
...
80105e5f:	6a 12                	push   $0x12
  jmp alltraps
80105e61:	e9 a8 fa ff ff       	jmp    8010590e <alltraps>
...
80105e68:	6a 13                	push   $0x13
  jmp alltraps
80105e6a:	e9 9f fa ff ff       	jmp    8010590e <alltraps>
...
80105e71:	6a 14                	push   $0x14
  jmp alltraps
80105e73:	e9 96 fa ff ff       	jmp    8010590e <alltraps>
...
80105e7a:	6a 15                	push   $0x15
  jmp alltraps
80105e7c:	e9 8d fa ff ff       	jmp    8010590e <alltraps>
...
80105e83:	6a 16                	push   $0x16
  jmp alltraps
80105e85:	e9 84 fa ff ff       	jmp    8010590e <alltraps>
...
80105e8c:	6a 17                	push   $0x17
  jmp alltraps
80105e8e:	e9 7b fa ff ff       	jmp    8010590e <alltraps>
...
80105e95:	6a 18                	push   $0x18
  jmp alltraps
80105e97:	e9 72 fa ff ff       	jmp    8010590e <alltraps>
...
80105e9e:	6a 19                	push   $0x19
  jmp alltraps
80105ea0:	e9 69 fa ff ff       	jmp    8010590e <alltraps>
...
80105ea7:	6a 1a                	push   $0x1a
  jmp alltraps
80105ea9:	e9 60 fa ff ff       	jmp    8010590e <alltraps>
...
80105eb0:	6a 1b                	push   $0x1b
  jmp alltraps
80105eb2:	e9 57 fa ff ff       	jmp    8010590e <alltraps>
...
80105eb9:	6a 1c                	push   $0x1c
  jmp alltraps
80105ebb:	e9 4e fa ff ff       	jmp    8010590e <alltraps>
...
80105ec2:	6a 1d                	push   $0x1d
  jmp alltraps
80105ec4:	e9 45 fa ff ff       	jmp    8010590e <alltraps>
...
80105ecb:	6a 1e                	push   $0x1e
  jmp alltraps
80105ecd:	e9 3c fa ff ff       	jmp    8010590e <alltraps>
...
80105ed4:	6a 1f                	push   $0x1f
  jmp alltraps
80105ed6:	e9 33 fa ff ff       	jmp    8010590e <alltraps>
...
80105edd:	6a 20                	push   $0x20
  jmp alltraps
80105edf:	e9 2a fa ff ff       	jmp    8010590e <alltraps>
...
80105ee6:	6a 21                	push   $0x21
  jmp alltraps
80105ee8:	e9 21 fa ff ff       	jmp    8010590e <alltraps>
...
80105eef:	6a 22                	push   $0x22
  jmp alltraps
80105ef1:	e9 18 fa ff ff       	jmp    8010590e <alltraps>
...
80105ef8:	6a 23                	push   $0x23
  jmp alltraps
80105efa:	e9 0f fa ff ff       	jmp    8010590e <alltraps>
...
80105f01:	6a 24                	push   $0x24
  jmp alltraps
80105f03:	e9 06 fa ff ff       	jmp    8010590e <alltraps>
...
80105f0a:	6a 25                	push   $0x25
  jmp alltraps
80105f0c:	e9 fd f9 ff ff       	jmp    8010590e <alltraps>
...
80105f13:	6a 26                	push   $0x26
  jmp alltraps
80105f15:	e9 f4 f9 ff ff       	jmp    8010590e <alltraps>
...
80105f1c:	6a 27                	push   $0x27
  jmp alltraps
80105f1e:	e9 eb f9 ff ff       	jmp    8010590e <alltraps>
...
80105f25:	6a 28                	push   $0x28
  jmp alltraps
80105f27:	e9 e2 f9 ff ff       	jmp    8010590e <alltraps>
...
80105f2e:	6a 29                	push   $0x29
  jmp alltraps
80105f30:	e9 d9 f9 ff ff       	jmp    8010590e <alltraps>
...
80105f37:	6a 2a                	push   $0x2a
  jmp alltraps
80105f39:	e9 d0 f9 ff ff       	jmp    8010590e <alltraps>
...
80105f40:	6a 2b                	push   $0x2b
  jmp alltraps
80105f42:	e9 c7 f9 ff ff       	jmp    8010590e <alltraps>
...
80105f49:	6a 2c                	push   $0x2c
  jmp alltraps
80105f4b:	e9 be f9 ff ff       	jmp    8010590e <alltraps>
...
80105f52:	6a 2d                	push   $0x2d
  jmp alltraps
80105f54:	e9 b5 f9 ff ff       	jmp    8010590e <alltraps>
...
80105f5b:	6a 2e                	push   $0x2e
  jmp alltraps
80105f5d:	e9 ac f9 ff ff       	jmp    8010590e <alltraps>
...
80105f64:	6a 2f                	push   $0x2f
  jmp alltraps
80105f66:	e9 a3 f9 ff ff       	jmp    8010590e <alltraps>
...
80105f6d:	6a 30                	push   $0x30
  jmp alltraps
80105f6f:	e9 9a f9 ff ff       	jmp    8010590e <alltraps>
...
80105f76:	6a 31                	push   $0x31
  jmp alltraps
80105f78:	e9 91 f9 ff ff       	jmp    8010590e <alltraps>
...
80105f7f:	6a 32                	push   $0x32
  jmp alltraps
80105f81:	e9 88 f9 ff ff       	jmp    8010590e <alltraps>
...
80105f88:	6a 33                	push   $0x33
  jmp alltraps
80105f8a:	e9 7f f9 ff ff       	jmp    8010590e <alltraps>
...
80105f91:	6a 34                	push   $0x34
  jmp alltraps
80105f93:	e9 76 f9 ff ff       	jmp    8010590e <alltraps>
...
80105f9a:	6a 35                	push   $0x35
  jmp alltraps
80105f9c:	e9 6d f9 ff ff       	jmp    8010590e <alltraps>
...
80105fa3:	6a 36                	push   $0x36
  jmp alltraps
80105fa5:	e9 64 f9 ff ff       	jmp    8010590e <alltraps>
...
80105fac:	6a 37                	push   $0x37
  jmp alltraps
80105fae:	e9 5b f9 ff ff       	jmp    8010590e <alltraps>
...
80105fb5:	6a 38                	push   $0x38
  jmp alltraps
80105fb7:	e9 52 f9 ff ff       	jmp    8010590e <alltraps>
...
80105fbe:	6a 39                	push   $0x39
  jmp alltraps
80105fc0:	e9 49 f9 ff ff       	jmp    8010590e <alltraps>
...
80105fc7:	6a 3a                	push   $0x3a
  jmp alltraps
80105fc9:	e9 40 f9 ff ff       	jmp    8010590e <alltraps>
...
80105fd0:	6a 3b                	push   $0x3b
  jmp alltraps
80105fd2:	e9 37 f9 ff ff       	jmp    8010590e <alltraps>
...
80105fd9:	6a 3c                	push   $0x3c
  jmp alltraps
80105fdb:	e9 2e f9 ff ff       	jmp    8010590e <alltraps>
...
80105fe2:	6a 3d                	push   $0x3d
  jmp alltraps
80105fe4:	e9 25 f9 ff ff       	jmp    8010590e <alltraps>
...
80105feb:	6a 3e                	push   $0x3e
  jmp alltraps
80105fed:	e9 1c f9 ff ff       	jmp    8010590e <alltraps>
...
80105ff4:	6a 3f                	push   $0x3f
  jmp alltraps
80105ff6:	e9 13 f9 ff ff       	jmp    8010590e <alltraps>
...
80105ffd:	6a 40                	push   $0x40
  jmp alltraps
80105fff:	e9 0a f9 ff ff       	jmp    8010590e <alltraps>
...
80106006:	6a 41                	push   $0x41
  jmp alltraps
80106008:	e9 01 f9 ff ff       	jmp    8010590e <alltraps>
...
8010600f:	6a 42                	push   $0x42
  jmp alltraps
80106011:	e9 f8 f8 ff ff       	jmp    8010590e <alltraps>
...
80106018:	6a 43                	push   $0x43
  jmp alltraps
8010601a:	e9 ef f8 ff ff       	jmp    8010590e <alltraps>
...
80106021:	6a 44                	push   $0x44
  jmp alltraps
80106023:	e9 e6 f8 ff ff       	jmp    8010590e <alltraps>
...
8010602a:	6a 45                	push   $0x45
  jmp alltraps
8010602c:	e9 dd f8 ff ff       	jmp    8010590e <alltraps>
...
80106033:	6a 46                	push   $0x46
  jmp alltraps
80106035:	e9 d4 f8 ff ff       	jmp    8010590e <alltraps>
...
8010603c:	6a 47                	push   $0x47
  jmp alltraps
8010603e:	e9 cb f8 ff ff       	jmp    8010590e <alltraps>
...
80106045:	6a 48                	push   $0x48
  jmp alltraps
80106047:	e9 c2 f8 ff ff       	jmp    8010590e <alltraps>
...
8010604e:	6a 49                	push   $0x49
  jmp alltraps
80106050:	e9 b9 f8 ff ff       	jmp    8010590e <alltraps>
...
80106057:	6a 4a                	push   $0x4a
  jmp alltraps
80106059:	e9 b0 f8 ff ff       	jmp    8010590e <alltraps>
...
80106060:	6a 4b                	push   $0x4b
  jmp alltraps
80106062:	e9 a7 f8 ff ff       	jmp    8010590e <alltraps>
...
80106069:	6a 4c                	push   $0x4c
  jmp alltraps
8010606b:	e9 9e f8 ff ff       	jmp    8010590e <alltraps>
...
80106072:	6a 4d                	push   $0x4d
  jmp alltraps
80106074:	e9 95 f8 ff ff       	jmp    8010590e <alltraps>
...
8010607b:	6a 4e                	push   $0x4e
  jmp alltraps
8010607d:	e9 8c f8 ff ff       	jmp    8010590e <alltraps>
...
80106084:	6a 4f                	push   $0x4f
  jmp alltraps
80106086:	e9 83 f8 ff ff       	jmp    8010590e <alltraps>
...
8010608d:	6a 50                	push   $0x50
  jmp alltraps
8010608f:	e9 7a f8 ff ff       	jmp    8010590e <alltraps>
...
80106096:	6a 51                	push   $0x51
  jmp alltraps
80106098:	e9 71 f8 ff ff       	jmp    8010590e <alltraps>
...
8010609f:	6a 52                	push   $0x52
  jmp alltraps
801060a1:	e9 68 f8 ff ff       	jmp    8010590e <alltraps>
...
801060a8:	6a 53                	push   $0x53
  jmp alltraps
801060aa:	e9 5f f8 ff ff       	jmp    8010590e <alltraps>
...
801060b1:	6a 54                	push   $0x54
  jmp alltraps
801060b3:	e9 56 f8 ff ff       	jmp    8010590e <alltraps>
...
801060ba:	6a 55                	push   $0x55
  jmp alltraps
801060bc:	e9 4d f8 ff ff       	jmp    8010590e <alltraps>
...
801060c3:	6a 56                	push   $0x56
  jmp alltraps
801060c5:	e9 44 f8 ff ff       	jmp    8010590e <alltraps>
...
801060cc:	6a 57                	push   $0x57
  jmp alltraps
801060ce:	e9 3b f8 ff ff       	jmp    8010590e <alltraps>
...
801060d5:	6a 58                	push   $0x58
  jmp alltraps
801060d7:	e9 32 f8 ff ff       	jmp    8010590e <alltraps>
...
801060de:	6a 59                	push   $0x59
  jmp alltraps
801060e0:	e9 29 f8 ff ff       	jmp    8010590e <alltraps>
...
801060e7:	6a 5a                	push   $0x5a
  jmp alltraps
801060e9:	e9 20 f8 ff ff       	jmp    8010590e <alltraps>
...
801060f0:	6a 5b                	push   $0x5b
  jmp alltraps
801060f2:	e9 17 f8 ff ff       	jmp    8010590e <alltraps>
...
801060f9:	6a 5c                	push   $0x5c
  jmp alltraps
801060fb:	e9 0e f8 ff ff       	jmp    8010590e <alltraps>
...
80106102:	6a 5d                	push   $0x5d
  jmp alltraps
80106104:	e9 05 f8 ff ff       	jmp    8010590e <alltraps>
...
8010610b:	6a 5e                	push   $0x5e
  jmp alltraps
8010610d:	e9 fc f7 ff ff       	jmp    8010590e <alltraps>
...
80106114:	6a 5f                	push   $0x5f
  jmp alltraps
80106116:	e9 f3 f7 ff ff       	jmp    8010590e <alltraps>
...
8010611d:	6a 60                	push   $0x60
  jmp alltraps
8010611f:	e9 ea f7 ff ff       	jmp    8010590e <alltraps>
...
80106126:	6a 61                	push   $0x61
  jmp alltraps
80106128:	e9 e1 f7 ff ff       	jmp    8010590e <alltraps>
...
8010612f:	6a 62                	push   $0x62
  jmp alltraps
80106131:	e9 d8 f7 ff ff       	jmp    8010590e <alltraps>
...
80106138:	6a 63                	push   $0x63
  jmp alltraps
8010613a:	e9 cf f7 ff ff       	jmp    8010590e <alltraps>
...
80106141:	6a 64                	push   $0x64
  jmp alltraps
80106143:	e9 c6 f7 ff ff       	jmp    8010590e <alltraps>
...
8010614a:	6a 65                	push   $0x65
  jmp alltraps
8010614c:	e9 bd f7 ff ff       	jmp    8010590e <alltraps>
...
80106153:	6a 66                	push   $0x66
  jmp alltraps
80106155:	e9 b4 f7 ff ff       	jmp    8010590e <alltraps>
...
8010615c:	6a 67                	push   $0x67
  jmp alltraps
8010615e:	e9 ab f7 ff ff       	jmp    8010590e <alltraps>
...
80106165:	6a 68                	push   $0x68
  jmp alltraps
80106167:	e9 a2 f7 ff ff       	jmp    8010590e <alltraps>
...
8010616e:	6a 69                	push   $0x69
  jmp alltraps
80106170:	e9 99 f7 ff ff       	jmp    8010590e <alltraps>
...
80106177:	6a 6a                	push   $0x6a
  jmp alltraps
80106179:	e9 90 f7 ff ff       	jmp    8010590e <alltraps>
...
80106180:	6a 6b                	push   $0x6b
  jmp alltraps
80106182:	e9 87 f7 ff ff       	jmp    8010590e <alltraps>
...
80106189:	6a 6c                	push   $0x6c
  jmp alltraps
8010618b:	e9 7e f7 ff ff       	jmp    8010590e <alltraps>
...
80106192:	6a 6d                	push   $0x6d
  jmp alltraps
80106194:	e9 75 f7 ff ff       	jmp    8010590e <alltraps>
...
8010619b:	6a 6e                	push   $0x6e
  jmp alltraps
8010619d:	e9 6c f7 ff ff       	jmp    8010590e <alltraps>
...
801061a4:	6a 6f                	push   $0x6f
  jmp alltraps
801061a6:	e9 63 f7 ff ff       	jmp    8010590e <alltraps>
...
801061ad:	6a 70                	push   $0x70
  jmp alltraps
801061af:	e9 5a f7 ff ff       	jmp    8010590e <alltraps>
...
801061b6:	6a 71                	push   $0x71
  jmp alltraps
801061b8:	e9 51 f7 ff ff       	jmp    8010590e <alltraps>
...
801061bf:	6a 72                	push   $0x72
  jmp alltraps
801061c1:	e9 48 f7 ff ff       	jmp    8010590e <alltraps>
...
801061c8:	6a 73                	push   $0x73
  jmp alltraps
801061ca:	e9 3f f7 ff ff       	jmp    8010590e <alltraps>
...
801061d1:	6a 74                	push   $0x74
  jmp alltraps
801061d3:	e9 36 f7 ff ff       	jmp    8010590e <alltraps>
...
801061da:	6a 75                	push   $0x75
  jmp alltraps
801061dc:	e9 2d f7 ff ff       	jmp    8010590e <alltraps>
...
801061e3:	6a 76                	push   $0x76
  jmp alltraps
801061e5:	e9 24 f7 ff ff       	jmp    8010590e <alltraps>
...
801061ec:	6a 77                	push   $0x77
  jmp alltraps
801061ee:	e9 1b f7 ff ff       	jmp    8010590e <alltraps>
...
801061f5:	6a 78                	push   $0x78
  jmp alltraps
801061f7:	e9 12 f7 ff ff       	jmp    8010590e <alltraps>
...
801061fe:	6a 79                	push   $0x79
  jmp alltraps
80106200:	e9 09 f7 ff ff       	jmp    8010590e <alltraps>
...
80106207:	6a 7a                	push   $0x7a
  jmp alltraps
80106209:	e9 00 f7 ff ff       	jmp    8010590e <alltraps>
...
80106210:	6a 7b                	push   $0x7b
  jmp alltraps
80106212:	e9 f7 f6 ff ff       	jmp    8010590e <alltraps>
...
80106219:	6a 7c                	push   $0x7c
  jmp alltraps
8010621b:	e9 ee f6 ff ff       	jmp    8010590e <alltraps>
...
80106222:	6a 7d                	push   $0x7d
  jmp alltraps
80106224:	e9 e5 f6 ff ff       	jmp    8010590e <alltraps>
...
8010622b:	6a 7e                	push   $0x7e
  jmp alltraps
8010622d:	e9 dc f6 ff ff       	jmp    8010590e <alltraps>
...
80106234:	6a 7f                	push   $0x7f
  jmp alltraps
80106236:	e9 d3 f6 ff ff       	jmp    8010590e <alltraps>
...
8010623d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106242:	e9 c7 f6 ff ff       	jmp    8010590e <alltraps>
...
80106255:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010625a:	e9 af f6 ff ff       	jmp    8010590e <alltraps>
...
80106261:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106266:	e9 a3 f6 ff ff       	jmp    8010590e <alltraps>
...
8010689a:	e8 31 de ff ff       	call   801046d0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106a07:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a0a:	e8 41 cf ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106a94:	a1 a4 57 11 80       	mov    0x801157a4,%eax
...
80106ad8:	0f 84 c2 00 00 00    	je     80106ba0 <switchuvm+0xf0>
  pushcli();
80106ade:	e8 dd d9 ff ff       	call   801044c0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106ae3:	e8 f8 cd ff ff       	call   801038e0 <mycpu>
80106ae8:	89 c3                	mov    %eax,%ebx
80106aea:	e8 f1 cd ff ff       	call   801038e0 <mycpu>
...
80106afc:	e8 df cd ff ff       	call   801038e0 <mycpu>
...
80106b45:	e8 96 cd ff ff       	call   801038e0 <mycpu>
...
80106b63:	e8 78 cd ff ff       	call   801038e0 <mycpu>
80106b68:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b6b:	e8 70 cd ff ff       	call   801038e0 <mycpu>
...
80106bf3:	e8 d8 da ff ff       	call   801046d0 <memset>
...
80106c26:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c27:	e9 44 db ff ff       	jmp    80104770 <memmove>
    panic("inituvm: more than a page");
80106c2c:	83 ec 0c             	sub    $0xc,%esp
80106c2f:	68 91 7a 10 80       	push   $0x80107a91
...
80106d99:	68 c9 7a 10 80       	push   $0x80107ac9
...
80106dfb:	68 e1 7a 10 80       	push   $0x80107ae1
...
80106edc:	68 fd 7a 10 80       	push   $0x80107afd
...
80106f14:	e8 b7 d7 ff ff       	call   801046d0 <memset>
...
80106f7f:	a3 a4 57 11 80       	mov    %eax,0x801157a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106fb3:	68 0e 7b 10 80       	push   $0x80107b0e
...
80107000:	e8 6b d7 ff ff       	call   80104770 <memmove>
...
80107099:	68 32 7b 10 80       	push   $0x80107b32
8010709e:	e8 ed 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
801070a3:	83 ec 0c             	sub    $0xc,%esp
801070a6:	68 18 7b 10 80       	push   $0x80107b18
...
8010712e:	e8 3d d6 ff ff       	call   80104770 <memmove>
    len -= n;
    buf += n;
