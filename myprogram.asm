...
main(void)
{
  ...
  15:	e8 19 03 00 00       	call   333 <clone>
...
printf(int fd, const char *fmt, ...)
{
 ...
 574:	eb 1a                	jmp    590 <printf+0x1a0>
          s = "(null)";
 576:	bb 84 07 00 00       	mov    $0x784,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c5:	a1 34 0a 00 00       	mov    0xa34,%eax
{
 ...
 5e6:	73 10                	jae    5f8 <free+0x38>
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	a3 34 0a 00 00       	mov    %eax,0xa34
}
 617:	5e                   	pop    %esi
 618:	5f                   	pop    %edi
 619:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 65d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 660:	8b 3d 34 0a 00 00    	mov    0xa34,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6a9:	8b 3d 34 0a 00 00    	mov    0xa34,%edi
 ...
 6d2:	e8 e9 fe ff ff       	call   5c0 <free>
  return freep;
 6d7:	a1 34 0a 00 00       	mov    0xa34,%eax
 ...
 704:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 707:	a3 34 0a 00 00       	mov    %eax,0xa34
}
 ...
 71e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 34 0a 00 00 38 	movl   $0xa38,0xa34
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf 38 0a 00 00       	mov    $0xa38,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 38 0a 00 00 38 	movl   $0xa38,0xa38
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
